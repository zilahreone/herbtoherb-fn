              ...
              {({ wasSearched }) => {
                return (
                  <div>
                    ...
                    <ErrorBoundary>
                      <Layout
                        // header={<SearchBox inputProps={{ placeholder: "custom placeholder" }} autocompleteSuggestions={true} debounceLength={0}/>}
                        header={<SearchBox view={({ value, onChange, onSubmit }) => (
                        ...
                        bodyFooter={<Paging />}
                        // bodyFooter={<Paging view={({current, resultsPerPage, totalPages}) => (
                        //   <div>
                        //     <button onClick={setCurrent(2)}>sdfsdf</button>
                        //     {/* <Pagination /> */}
                        //   </div>
                        // )}/>}
                      />
