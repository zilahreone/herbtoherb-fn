...
function Search() {
  return (
    <>
      <div className="container-child gc-v-container w-full bg-orange-400">
        ...
        <div className='gc-h-container w-full'>
          <div className='grow bg-red-300'>1st bar</div>
          <div className='grow bg-red-300'>2nd bar</div>
          <div className='grow bg-red-300'>3rd bar</div>
        </div>
      </div>
    </>
  )
